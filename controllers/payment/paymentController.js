...
const stripe = require("stripe")(
  "sk_test_51MUj9ILeuFX1VKHiI38j8M1Vjax91YPYKAV3skMlxIjo2xIOwCibh5sZrypCm7ol4C8goY4opRpjGLHhW5BP03er00iU1onFam"
);
    ...
    try {
      ...
      if (stripInfo) {
        ...
        const accountLink = await stripe.accountLinks.create({
          account: account.id,
          refresh_url: "https://toko-client.vercel.app/refresh",
          return_url: `https://toko-client.vercel.app/success?activeCode=${uid}`,
